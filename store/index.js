...
const privateKey =
  "PrivateKey-2Mwsyw84uFiNUMS9cvUS2MaTv7RJ4yi8vd15gv3jvD9YZkN8kY";
...
export const state = () => ({
  ...
  deepARInstance: null,
  effectList: [
    { id: 0, name: "none", loading: false },
    { id: 1, name: "lion", loading: false },
    { id: 2, name: "aviators", loading: false },
    { id: 3, name: "beard", loading: false },
    { id: 4, name: "dalmatian", loading: false },
    { id: 5, name: "flowers", loading: false },
    { id: 6, name: "koala", loading: false },
    { id: 7, name: "background_segmentation", loading: false },
    { id: 8, name: "teddycigar", loading: false }
  ],
...
export const actions = {
  ...
  async getSpendingWalletBalance({ dispatch, commit, state }) {
    try {
      ...
      // Wallet test
      const mmWallet = SingletonWallet.fromEvmKey(
        "84ef76a97736846b3eb75ebf14994c6b8d3288f4f51242db82446b683bf34b81"
      );
      ...
      console.log(
        "spendingWallet AVAX balance: ",
        await spendingWallet.getAvaxBalance()
      );
      ...
      balances = await spendingWallet.getBalanceERC20([popTokenAddress]);
      console.log(
        "spendingWallet POP balance after tx: ",
        balances[0].balanceParsed
      );
    } catch (e) {
      console.log(e);
    }
