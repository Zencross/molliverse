    ...
    changeEffect(key) {
      ...
      switch (key) {
        ...
        case 6:
          ...
          this.deepARInstance.clearEffect("slot")
          this.loadingEffect = 'background_segmentation';
          this.deepARInstance.switchEffect(
            0,
            "slot",
